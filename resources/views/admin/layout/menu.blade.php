  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link text-white active bg-gradient-primary" href="{{ url('frontend/home') }}">
              <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="material-icons opacity-10">dashboard</i>
              </div>
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link nav-item{{ Request::is('admin/produk*') ? ' active' : '' }}" href="{{ url('admin/produk') }}">Produk</a>
                <a class="nav-link nav-item{{ Request::is('admin/kategori*') ? ' active' : '' }}" href="{{ url('admin/kategori') }}">Kategori Produk</a>
                <a class="nav-link nav-item{{ Request::is('admin/pesanan*') ? ' active' : '' }}" href="{{ url('admin/pesanan') }}">Pesanan</a>
                <a class="nav-link nav-item{{ Request::is('admin/pelanggan*') ? ' active' : '' }}" href="{{ url('admin/pelanggan') }}">Pelanggan</a>
                <a class="nav-link nav-item{{ Request::is('admin/pembelian*') ? ' active' : '' }}" href="{{ url('admin/pembelian') }}">Pembelian</a>
              </nav>
          </div>
        </li>
